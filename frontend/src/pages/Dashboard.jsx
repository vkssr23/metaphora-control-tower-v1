...
const KPI = ({ label, value, hint, icon: Icon, tone="default", testId }) => {
  const toneMap = { danger:"text-red-400", success:"text-emerald-400", warn:"text-amber-400", default:"text-zinc-100" };
  return (
    <div className="terminal-card p-3" data-testid={testId}>
      <div className="flex items-center justify-between mb-2">
        <div className="kpi-label">{label}</div>
        {Icon && <Icon className={`w-3.5 h-3.5 ${toneMap[tone]}`} strokeWidth={1.5} />}
      </div>
      <div className={`kpi-value ${toneMap[tone]}`}>{value}</div>
      {hint && <div className="text-[11px] text-zinc-500 mt-1 font-mono">{hint}</div>}
    </div>
  );
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="terminal-card p-4 lg:col-span-2">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <div className="kpi-label">Revenue by Week</div>
              ...
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={charts.revenue_by_week}>
                  ...
                  <Tooltip contentStyle={{background:"#0C0C0F",border:"1px solid #27272A",fontSize:12}} />
            ...
            <div className="terminal-card p-4">
              <div className="kpi-label">Load Status Distribution</div>
            ...
            <div className="terminal-card p-4">
              <div className="kpi-label">Fuel Cost Trend</div>
            ...
            <div className="terminal-card p-4">
              <div className="kpi-label">Revenue by Driver</div>
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={charts.profit_by_driver} layout="vertical">
                  ...
                  <YAxis type="category" dataKey="driver" stroke="#71717A" fontSize={10} width={70} />
                  <Tooltip contentStyle={{background:"#0C0C0F",border:"1px solid #27272A",fontSize:12}} />
