...
export default function ExecutionEligibility({loadId}){
  ...
  return <div className="terminal-card p-4" data-testid="execution-eligibility">
    ...
    <div className="mt-2 text-[11px] text-amber-400">Driver, compliance, HOS and equipment statuses shown here are internal administrative/planning checks until connected to authoritative external systems.</div>
